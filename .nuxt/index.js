...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"TIGA | Portfolio","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-svg","href":"\u002Ffavicon.svg"}],"style":[],"script":[]},
